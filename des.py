...
class des():
    ...
    def run(self, key, text, action=ENCRYPT, padding=False):
        ...
        for block in text_blocks:#Loop over all the blocks of data
            ...
            tmp = None
            for i in range(self.round): #Do the 16 rounds
                ...
                if action == ENCRYPT:
                    ...
                    tmp = self.xor(self.keys[self.round-1-i], right_e) # If decrypt start by the last key
            ...
            result += right+left #Do the last permut and append the result to result
